  ...
  return (
   <div className='flex flex-col gap-4'>
    <h1 className='text-2xl font-semibold text-white'>
      {isSignIn ? 'Welcome back to UniLib' : 'Create your library account'}
    </h1>
    <p className='text-light-100'>
      {isSignIn ? 'Acces a limitless resource of knowledge and continue learning!' : 'Welcome to UniLib! Kindly input the correct and valid details in each of the fields below.'}
    </p>
     <Form {...form}>
